...
public class SipRawKafkaStreamingJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        callsWithPrefix.print("WITH2-PREFIX");
        ...
        windowedCounts.print("WINDOWED2-COUNTS");
        ...
        anomalies.print("ALL2-ANOMALIES");
        ...
        significantAnomalies.print("SIP2-ANOMALY");
    ...
    public static class SipCallEvent {
        ...
        public String toString() {
            return String.format("SipCall{from=%s, to=%s, from_country=%s, callId=%s}", 
                from_address, to_address, from_country, call_id);
        }
    }
